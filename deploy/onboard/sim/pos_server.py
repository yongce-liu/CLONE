...
class PositionServer:
    ...
    def __init__(self, config: dict):
        ...
        self.server_ip = config['server_ip'] # Server IP is not strictly used for binding, but kept for context
        ...
        print(f"[Position Server] Position server has started on port {self.port}, waiting for client connections...")
    ...
    def send_process(self):
        ...
        """
        # 启动 ROS 2 节点进程
        self.ros_process = Process(target=PositionNode.start_main_loop, args=(self.queue,))
